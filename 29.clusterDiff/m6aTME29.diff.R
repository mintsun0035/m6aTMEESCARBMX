setwd("C:\\Users\\TLSP\\Desktop\\m6a-ESCA\\29.clusterDiff")
...
cluFile="m6aCluster.txt"      #聚类结果文件
# adj.P.Val.Filter=0.05        #矫正后p值阈值(原来是0.001)
adj.P.Val.Filter=0.001       #矫正后p值阈值(原来是0.001)
